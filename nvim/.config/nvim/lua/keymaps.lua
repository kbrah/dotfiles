...
keymap('n', '<leader>lwr', '<cmd>ConjureEval (user/reload-worker)<cr>', opts)
keymap('n', '<leader>lws', '<cmd>ConjureEval (user/start-worker)<cr>', opts)
keymap('n', '<leader>lwx', '<cmd>ConjureEval (user/stop-worker)<cr>', opts)
